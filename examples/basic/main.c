...
int main(int argc, char **argv)
{
    ...
    struct LedFont *fonts[2];
    fonts[FONT_ID_4X6] = load_font("../submodules/rpi-rgb-led-matrix/fonts/4x6.bdf");
    fonts[FONT_ID_5X7] = load_font("../submodules/rpi-rgb-led-matrix/fonts/5x7.bdf");
